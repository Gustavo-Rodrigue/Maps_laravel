...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Evento de clique no mapa para atualizar coordenadas
    ...
    // Adicionar controle de busca (geocoder)
    ...
    .on('markgeocode', function(e) {
        ...
        // Atualizar também o campo endereço
        document.getElementById('address').value = e.geocode.name;

        // Mover marcador para a posição da busca
        marker.setLatLng(latlng).openPopup();

        // Centralizar mapa na posição da busca
        map.setView(latlng, 15);

        // Atualizar popup do marcador com o nome do lugar buscado
        marker.bindPopup(`
            <div class="text-center">
