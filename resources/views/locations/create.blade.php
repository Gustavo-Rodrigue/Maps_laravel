...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('locations.index') }}" class="btn btn-custom">
...
@section('styles')
<!-- Leaflet e Geocoder CSS -->
<link rel="stylesheet" href="https://unpkg.com/leaflet/dist/leaflet.css" />
<link rel="stylesheet" href="https://unpkg.com/leaflet-control-geocoder/dist/Control.Geocoder.css" />
@endsection

@section('scripts')
<!-- Leaflet e Geocoder JS -->
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Função para adicionar marcador e preencher campos
    function setMarker(lat, lng, popupText = null) {
        if (marker) {
    ...
    map.on('click', function (e) {
        ...
        // Se quiser preencher o endereço automaticamente no clique,
        // basta ativar reverse geocoding aqui.
    });

    // Geocoder (barra de busca)
    L.Control.geocoder({
    ...
    .on('markgeocode', function (e) {
        ...
        // Define o marcador e preenche latitude/longitude
        setMarker(latlng.lat, latlng.lng, `
            <div class="text-center">
                <strong>${e.geocode.name}</strong><br>
