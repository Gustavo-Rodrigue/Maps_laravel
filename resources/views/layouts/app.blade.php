...
<body>
    <nav class="navbar navbar-custom navbar-expand-lg navbar-dark ">
        <div class="container">
            <a style="color: black;" class="navbar-brand" href="{{ route('locations.index') }}">
                <img src="{{ asset('Assets/85084.png') }}" style="width: 50px; color:white; " alt="">
                Laravel Maps App
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a style="color: black;" class="nav-link" href="{{ route('locations.index') }}">
                            <i class="fas fa-list me-1"></i>Locais
                        </a>
                    </li>
                    <li class="nav-item">
                        <a style="color: black;" class="nav-link" href="{{ route('locations.create') }}">
